...
* more abuse the force images
* convert size to 1024x768
* change font size for code
* break up some code to multiple slides
* add funny pics to slides
* implement growing bubble
